...
<body>
			...
			<ul class="nav navbar-right">
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li>
							<a href="student_update.php"><i class="glyphicon glyphicon-cog"></i> Update Account</a>
						</li>
						<li>
	...
	<div class="col-md-8">
		<div class="alert alert-info" style="margin-top:100px;"><b>File List</b></div>
	...
	<div class="col-md-4">
		<div class="panel panel-primary" style="margin-top:20%;">
			...
			<div class="panel-body">
				...
				<hr style="border-top:1px dotted #ccc;" />
				<h4>College Department: <label class="pull-right"><?php echo $fetch['department'] ?></label></h4>
				<hr style="border-top:1px dotted #ccc;" />
				<h4>Course: <label class="pull-right"><?php echo $fetch['course'] ?></label></h4>
				<hr style="border-top:1px dotted #ccc;" />
				<h4>Major: <label class="pull-right"><?php echo $fetch['major'] ?></label></h4>
				<hr style="border-top:1px dotted #ccc;" />
				<h4>Year & Section: <label class="pull-right"><?php echo $fetch['year'] ?></label></h4>
				<hr style="border-top:1px dotted #ccc;" />
				<h4>Status: <label class="pull-right"><?php echo $fetch['status'] ?></label></h4>
				<hr style="border-top:1px dotted #ccc;" />
				<h4>Cabinet: <label class="pull-right"><?php echo $fetch['cabinet'] ?></label></h4>
				<hr style="border-top:1px dotted #ccc;" />
				<h3>File</h3>
